...
class FavoriteButton (QtWidgets.QPushButton):
    ...
    def paintEvent (self, event):
        ...
        if self.isChecked():
            image = graphics.recolor(self.image, self.theme.color.browserSocketPressed)
...
class ThemeButton (QtWidgets.QPushButton):
    ...
    def paintEvent (self, event):
        ...
        if self.dark:
            ...
            image = self.sun
        if self.buttonPressed:
            image = graphics.recolor(image, self.theme.color.browserSocketPressed)
        elif self.buttonHover:
            image = graphics.recolor(image, self.theme.color.browserSocketHover)
        else:
            image = graphics.recolor(image, self.theme.color.browserSocket)
        painter.drawImage(position, image)
        painter.end()
...
class FavoriteGroup (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        super(FavoriteGroup, self).__init__(parent)
        ...
        uiCommand.setFont(self.label, UIGlobals.Bar.fontPreview)
...
class BookmarkGroup (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        super(BookmarkGroup, self).__init__(parent)
        self.mainLayout = QtWidgets.QHBoxLayout()
        self.mainLayout.setContentsMargins(0,0, SPACE*2 ,0)
        self.mainLayout.setSpacing(SPACE)
...
class ThemeGroup (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        super(ThemeGroup, self).__init__(parent)
        self.theme = theme
...
class PreviewGroup (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        super(PreviewGroup, self).__init__(parent)
        self.mainLayout = QtWidgets.QHBoxLayout()
...
class ComboBox (QtWidgets.QComboBox):
    ...
    def showPopup (self):
        ...
        popup.move(popup.x(), point.y() - popup.height())
...
class Bar (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        ...
        self.spacerCenter = QtWidgets.QSpacerItem(
        ...
        self.spacerRight = QtWidgets.QSpacerItem(
            0, 0, QtWidgets.QSizePolicy.Expanding,
            QtWidgets.QSizePolicy.Minimum)
