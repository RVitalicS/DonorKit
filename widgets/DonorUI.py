...
class UsdLoadOptions (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        super(UsdLoadOptions, self).__init__(parent)
        self.setObjectName("UsdLoadOptions")
        self.setAutoFillBackground(True)
        palette = QtGui.QPalette()
        palette.setColor(
            QtGui.QPalette.Background,
            QtGui.QColor(theme.color.optionBackground) )
        ...
        self.linkLayout.setContentsMargins(MARGIN, 0, MARGIN, MARGIN)
        ...
        uiCommand.setFont(self.loadButton, UIGlobals.Options.fontLabel)
