...
class Base (object):
    ...
    def paintFolder (self):
        ...
        self.painter.drawText(
            QtCore.QRectF(self.folderNameArea), textName, textOption)
        # ITEMS
        self.painter.setPen(
            QtGui.QPen(
        ...
        self.painter.drawText(
            QtCore.QRectF(countArea), text, textOption)
        # LINK
    ...
    def paintPlus (self):
        ...
        self.createFolderArea = QtCore.QRect(
            ...
            libraryImage.width(), libraryImage.height())
        if self.createFolderArea.contains(self.pointer):
            libraryImage = graphics.recolor(
...
class Item (BaseItem.Painter, Base):
    ...
    def paint (self, painter, option, index):
        ...
        if self.type == "labelfolder":
            self.paintLabel()
        elif self.type in ["folder", "folderquery", "foldercolors" ]:
            self.paintFolder()
