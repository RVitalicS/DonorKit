...
class InheritButton (QtWidgets.QPushButton):
    ...
    def paintEvent (self, event):
        ...
        if not self.checked:
            ...
            brush = QtGui.QBrush(
                QtGui.QColor(self.theme.color.optionBackground) )
            painter.fillPath(path, brush)
        ...
        painter.drawText(QtCore.QRectF(buttonRect), "INHERIT", textOption)
        painter.end()
...
class RenderOptions (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        super(RenderOptions, self).__init__(parent)
        ...
        uiCommand.setFont(self.renderLabel, UIGlobals.Options.fontLabel)
        self.renderLabel.setAlignment(
...
class ExportOptions (QtWidgets.QWidget):
    ...
    def __init__ (self, theme, parent=None):
        ...
        self.mayaLayout.setContentsMargins(
            0, 0, 0, UIGlobals.Options.Maya.offset)
    ...
    def setOptionWidth (self, value):
        ...
        self.status.setFixedWidth(value + MARGIN - self.mayaButton.width() )
